...
# ============================================================================
#                     CLASSE INTERLACED SCAN  (solo PV name ovunque)
# ============================================================================
class InterlacedScan:
    ...
    def __init__(
        ...
        # initialize derived PVs serve per aggiornare i PV quando vengono aggiornati
    ...
    def _update_derived_pvs(self):
        ...
        Aggiorna i PV derivati :
          1) InterlacedRotationStop = ultimo angolo effettivamente acquisito (theta_monotonic[-1])
    ...
    def stop_angle(self, metodo=""):
        ...
        # aggiorna il PV (come da tua riga finale)
    ...
    def delta_theta_min(self, metodo=""):
        ...
        # opzionale ma sano: ignora eventuali zero  ( ve ne sono in alcuni metodi )
    ...
    # =========================================================
    # FUNZIONI (motion + PSO) — riscritte usando PV name
    # =========================================================
